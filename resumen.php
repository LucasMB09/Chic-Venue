...
<div class="container py-3">
  <header>
    ...
    <div class="pricing-header">
      <p class="fs-7 text-body-secondary">Ulises Gomez. Se ha realizado su compra con exito.</p>
    </div>
  </header>
        ...
        <div class="card mb-4 rounded-3 shadow-lg" style= "width: 97%; height: 50%;" >
          ...
          <div class="card-body">
            ...
            <ul ">
              ...
              <li>Talla G</li>
              <li>Bordado de flores</li>
              <li>$320.00 x unidad</li>
            </ul>
          </div>
        </div>
      </div>
